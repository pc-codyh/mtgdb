...
public class NewDraft extends Activity
{
	// NumberPicker to choose the amount of players
	// in the draft/tournament.
	...
	// ListViews that display the possible draft
	// and playoff types.
	ExpandableListView _draftTypesList;
	ExpandableListView _playoffTypesList;
	
	// CheckBox to choose if there are playoffs
	// or not for this draft.
	...
	public void onCreate(Bundle savedInstanceState)
	{
		...
		setContentView(R.layout.new_draft);
		
		initializeGlobalVariables();
		
		setMinAndMaxPlayerValues();
		setPossibleDraftTypes();
	...
	private void initializeGlobalVariables()
	{
		...
		_draftTypesList = (ExpandableListView) findViewById(R.id.nd_draft_type_sel);
	...
	// draft and playoff types.
	private void setPossibleDraftTypes()
	{
		_draftTypesList.setAdapter(new CustomExpandableListAdapter
		(this, _util.DRAFT_TYPES, _util.DRAFT_SUBTYPES_ELIM, _util.DRAFT_SUBTYPES_RR));
		...
		_util.setListViewHeightBasedOnChildren(_draftTypesList);
