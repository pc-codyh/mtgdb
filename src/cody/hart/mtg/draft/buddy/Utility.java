...
public class Utility
{
	...
	public final String DRAFT_TYPES[] = {"Elimination", "Round Robin"};
	
	// String array that holds the possible
	// elimination draft sub-types.
	public final String DRAFT_SUBTYPES_ELIM[] = {"Single Elimination", "Double Elimination"};
	
	// String array that holds the possible
	// round robin draft sub-types.
	public final String DRAFT_SUBTYPES_RR[] = {"Pool Play", "Swiss"};
	//********************//
